            ...
            <div className="md:flex">
                {
                    ...
                    <Modal isOpen={isModalOpen} onClose={closeModal}>
                        ...
                        <h2 className="text-indigo-500">El procedimiento de practicas preprofesionales ahora requiere en su Inicio la Carta de Notificación al Tutor, revisar Procedimiento</h2>
                    </Modal>
                }

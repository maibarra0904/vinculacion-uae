...
import PlanificacionPdf from "@/components/ui/PlanificacionPdf";
...
const Planificador = () => {
  ...
  const holidays = [
    ...
    new Date("2025-09-17T05:00:00.000Z"), // Feriado Local
  ...
  // Función para calcular horas totales por semana
  ...
  useEffect(() => {
    ...
    let remainingHoursToPlan = currentRequiredHours;
  ...
  }, [startDate, schedule, considerHolidays, currentRequiredHours, holidays]); // Dependencia de currentRequiredHours
            ...
            <PDFDownloadLink
              document={
                <PlanificacionPdf
                  ...
                  startDate={startDate}
                  endDate={endDate}
                  requiredHours={currentRequiredHours} // Pasa el valor dinámico
